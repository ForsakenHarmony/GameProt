...
//    manager.logger.level = Logger.INFO
  ...
  fun startLoading() {
    ...
    manager.load("spaceShooter2.png", Texture::class.java)
  ...
  fun load() {
    ...
    parseSheet("sheet.xml", manager.get("sheet.png"))
    parseSheet("spaceShooter2.xml", manager.get("spaceShooter2.png"))
  ...
  fun parseSheet(name: String, sheet: Texture) {
    val sheetXML = Gdx.files.internal(name)
